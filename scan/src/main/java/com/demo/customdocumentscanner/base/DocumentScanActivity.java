...
package com.demo.customdocumentscanner.base;
...
import com.demo.customdocumentscanner.base.libraries.NativeClass;
    ...
    protected void startCropping() {
        ...
        disposable.add(Observable.fromCallable(new Callable<Object>() {
                    ...
                    public Object call() throws Exception {
                        DocumentScanActivity.this.setImageRotation();
                        return false;
                    }
                })
                        ...
                        .subscribe(new Consumer<Object>() {
                            ...
                            public void accept(Object result) throws Exception {
                                DocumentScanActivity.this.initializeCropping();
                                DocumentScanActivity.this.setProgressBar(false);
                            }
                        })
        );
    }
