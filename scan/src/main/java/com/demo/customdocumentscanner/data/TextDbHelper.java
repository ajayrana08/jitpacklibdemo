...
public class TextDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_TEXT_TABLE = "CREATE TABLE "
                ...
                + TextContract.TextEntry.COLUMN_SUMMARY + " TEXT NOT NULL,"
                + TextContract.TextEntry.COLUMN_DESCRIPTION
                + " TEXT NOT NULL"
                + ");";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL(" DROP TABLE IF EXISTS "+ TextContract.TextEntry.TABLE_NAME);
        onCreate(db);
    }
}
