package com.demo.customdocumentscanner.data;
...
public class TextProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // Set the table
        queryBuilder.setTables(TextContract.TextEntry.TABLE_NAME);
        ...
        switch (match){
            ...
            case TEXT_ID:
                ...
                queryBuilder.appendWhere(TextContract.TextEntry._ID + "=" + uri.getLastPathSegment());
                break;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match){
            case TEXTS: {
                id = db.insert(TextContract.TextEntry.TABLE_NAME, null, values);

                if (id > 0) {
                    // Return URI of the newly inserted data from db
                    returnUri = TextContract.TextEntry.buildTextUri(id);
                } else {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case TEXTS:
                rowsDeleted = db.delete(TextContract.TextEntry.TABLE_NAME, selection, selectionArgs);
                break;
            ...
            case TEXT_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = db.delete(
                            ...
                            TextContract.TextEntry._ID + "=" + id,
                            null);
                } else {
                    // Delete data with specified _ID and selection
                    rowsDeleted = db.delete(
                            TextContract.TextEntry.TABLE_NAME,
                            TextContract.TextEntry._ID + "=" + id+ " and " + selection,
                            selectionArgs);
                }
                break;
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case TEXTS:
                rowsUpdated = db.update(TextContract.TextEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            case TEXT_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
    ...
    private void checkColumns(String[] projection) {
        String[] available = {TextContract.TextEntry.COLUMN_SUMMARY, TextContract.TextEntry.COLUMN_DESCRIPTION, TextContract.TextEntry._ID };
