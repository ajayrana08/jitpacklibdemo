...
import com.demo.customdocumentscanner.R
...
class PolygonView : FrameLayout {
    ...
    fun getListPoint(): ArrayList<Point> {
        ...
        listPoints.add(Point(pointer1!!.x.toDouble()-40 + pointer1!!.width / 2, pointer1!!.y.toDouble()-50 + pointer1!!.height / 2))
        listPoints.add(Point(pointer2!!.x.toDouble()+40 + pointer1!!.width / 2, pointer2!!.y.toDouble()-50 + pointer1!!.height / 2))
        listPoints.add(Point(pointer4!!.x.toDouble()+40 + pointer1!!.width / 2, pointer4!!.y.toDouble()+60 + pointer1!!.height / 2))
        listPoints.add(Point(pointer3!!.x.toDouble()-40 + pointer1!!.width / 2, pointer3!!.y.toDouble()+60 + pointer1!!.height / 2))
        return listPoints
    }
    ...
    var points: Map<Int, Point>?
        get() {
            ...
            if(pointer1!!.x.toDouble() == 0.0 && pointer2!!.x.toDouble() == 900.0 && pointer3!!.x.toDouble() == 0.0 && pointer4!!.x.toDouble() == 900.0 && pointer1!!.y.toDouble() == 0.0 && pointer2!!.y.toDouble() == 0.0 && pointer3!!.y.toDouble() == 1500.0 && pointer4!!.y.toDouble() == 1500.0)
            {
                points.add(Point(20.0,60.0))
                points.add(Point(800.0,60.0))
                points.add(Point(20.0,1357.0))
                points.add(Point(800.0,1357.0))
            }
            else{
